...
Vamos a conectarnos a mysql con el siguiente comando, habrá que ponerle una contraseña, aunque durante la instalación ya se la puse:  
 mysql -uroot -p  
...
Debemos crear (en mi caso), otra BD en la máquina SWAP2, ya que debe existir para saber donde importar el archivo .sql recuperado en el objetivo anterior  
